...
**Argus Enterprise SSO:** [**Enterprise SSO / OIDC (Keycloak)**](../enterprise-sso-oidc.md) · [**user manual**](../user/enterprise-sso.md) — demo logins (`demo`/`demo`, `ssouser`/`Sso@321`), Helm Keycloak, bring-your-own IdP, or local username/password.
...
- [User manual — Enterprise SSO](../user/enterprise-sso.md) — same guide in the operator manual / Admin Basics PDF
